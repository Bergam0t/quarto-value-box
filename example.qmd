...
We can also combine this with text position. Note that `icon-position` and `value-position` are independent — an icon on the left doesn't force the value into a row with it.
...
::: {.value-box icon="bi-star" icon-position="left" value-position="left" align="right" color="bg-teal" value="42"}
...
Font awesome and bootstrap icons support recoloring
...
```md
::: {.value-box icon="fa-brands fa-python" icon-position="left" icon-color="fuchsia"}
Font awesome icons
:::
```
