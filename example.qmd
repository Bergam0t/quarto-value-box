...
::: {style='font-size: 60%;'}
By default the title's size comes from the extension's stylesheet (`0.9rem`) rather than being set inline, so your own CSS can restyle titles without needing `!important`.
:::
