...
.highlight-box { outline: 3px dashed gold; outline-offset: 4px; }
</style>

::: {style='font-size: 55%;'}
Beyond the parameters this extension defines, a value box behaves like any other div: an `#id`, extra `.classes`, and attributes it doesn't itself use (`role`, `aria-*`, `data-*`, or anything else) all pass through onto the rendered box.
:::
