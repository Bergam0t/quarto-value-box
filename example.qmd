...
::: {.value-box icon="fa-solid fa-clipboard" value="Step 1"}
...
```md
::: {.value-box icon-position="left" icon="bi-star" value="42"}
Left-aligned icon
:::
```
...
```md
::: {.value-box icon-position="right" icon="bi-star" value="99"}
Right-aligned icon
:::
```
...
Font awesome, bootstrap icons, and material symbols support recoloring
