...
::: {.value-box icon="bi-star" value-position="left" value="42"}
Left-aligned value
:::

::: {.value-box icon="bi-star" value-position="right" value="99"}
Right-aligned value
:::

::: {.value-box icon="bi-star" value-position="bottom" value="7"}
Value below details
:::
