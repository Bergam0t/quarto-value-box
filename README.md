...
| `icon-size`           | string                              | `3em` / `128px` | Size of the icon. Font-based icons (`bi`, `fa`) default to `3em`; image-based (`svg`, `png`) default to `128px`. Accepts any valid CSS size unit.                                                                                                                                                                                                                                                 |
| `icon-position`       | `top` | `bottom` | `left` | `right` | `top`           | Where the icon is rendered relative to the box content.                                                                                                                                                                                                                                                                                                                                           |
| `icon-color`          | string                              | `white`         | Colour of Font Awesome or Bootstrap Icons. Ignored for image-based icons (`svg`, `png`). Accepts any valid CSS colour value.                                                                                                                                                                                                                                                                      |
