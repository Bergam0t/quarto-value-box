...
- [Customisation](#customisation)
  - [Row / grid layout](#row--grid-layout)
    - [Row parameters](#row-parameters)
  - [Value box parameters](#value-box-parameters)
    - [Content](#content)
    - [Icon customisation](#icon-customisation)
    - [Font customisation](#font-customisation)
    - [Layout & appearance](#layout--appearance)
    - [Links & Reveal.js](#links--revealjs)
    - [Advanced: custom style hooks](#advanced-custom-style-hooks)
- [Advanced Customisation](#advanced-customisation)
  - [Setting defaults for a whole project](#setting-defaults-for-a-whole-project)
  - [Colours](#colours)
  - [Brand colours (`_brand.yml`)](#brand-colours-_brandyml)
- [Acknowledgements](#acknowledgements)
- [Contributing](#contributing)
- [Generative AI use disclosure and policy](#generative-ai-use-disclosure-and-policy)
...
These attributes are set on the `.value-box-row` wrapper itself, to control the grid/flex layout of the boxes inside it.
...
These attributes are set directly on a `.value-box` div. They are grouped below by what they customise — content, icon, font, layout, links, and advanced style hooks — to make the full list easier to scan; see the [inheritable attributes](#row--grid-layout) note above for which of these can also be set once on a `.value-box-row` instead of repeated on every child box.

#### Content

The core text and stat fields of a box.
...
Everything about choosing, sizing, colouring, and placing the box's icon.
...
Font sizes and text colours for the box's content, value, title, and delta.
...
Box background, sizing, spacing, and alignment.
...
Turning a box into a link, and controlling its behaviour as a Reveal.js fragment.
...
#### Advanced: custom style hooks

Escape hatches that inject raw CSS onto specific internal elements of a box, for customisation beyond the built-in options above.
